...
<head>
    ...
    <link rel="stylesheet" href="{$WWW_JS}pdf-js/viewer.css"/>
    <link rel="stylesheet" href="{$WWW_CSS}pdf-css/pdf-flip.css"/>
    <style>
        .se-pre-con {
            position: fixed;
            left: 0px;
            ...
            <div id="toolbarContainer">
                <div id="toolbarViewer">
                    <div id="toolbarViewerLeft">
                        <button id="sidebarToggle" class="toolbarButton" title="Toggle Sidebar" tabindex="11" style="display: none"
                    ...
                    <div id="toolbarViewerRight">
                        <button id="presentationMode" class="toolbarButton presentationMode hiddenLargeView" style="display: none"
...
<script>
    let DEFAULT_URL =  "{$WWW}informativosPDF/arquivo-teste.pdf";    
    let WWW_JS = '{$WWW_JS}pdf-js/';
    let WWW_CSS = '{$WWW_CSS}pdf-css/';
    let WWW_IMG = '{$WWW_IMG}pdf-imagem/';
</script>

<script src="{$WWW_JS}pdf-js/compatibility.js"></script>
<!-- This snippet is used in production (included from viewer.html) -->
<link rel="resource" type="application/l10n" href="{$WWW_JS}pdf-js/locale/locale.properties"/>
<script src="{$WWW_JS}jquery-3.2.1.min.js"></script>
<script src="{$WWW_JS}pdf-turnjs/turn.min.js"></script>
<script src="{$WWW_JS}pdf-turnjs/zoom.min.js"></script>
<script src="{$WWW_JS}pdf-js/l10n.js"></script>
<script src="{$WWW_JS}pdf-js/build/pdf.js"></script>
<script src="{$WWW_JS}pdf-js/debugger.js"></script>
<script src="{$WWW_JS}pdf-js/viewer.js"></script>
<script src="{$WWW_JS}pdf-js/pdf-flip.js?v=1.1.1.1.1.1"></script>
<script>
